...
# Edge Impulse library for EMG sensors 2 channels Hoan hand

This is a C++ library that lets you run the impulse for "EMG sensors 2 channels Hoan hand" (https://studio.edgeimpulse.com/studio/1018567) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
